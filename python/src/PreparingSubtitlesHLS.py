                    ...
                    if os.path.exists(local_media_hls):
                        ...
                        with open(local_media_hls) as manifest_hls_file:
                            for manifest_hls_line in manifest_hls_file:
                                # self.file_manager.log("READLN [" + media_id + "] manifest_hls_line:" + manifest_hls_line)
                                            ...
                                            with open(local_replace_subtitle_segment) as local_replace_subtitle_segment_file:
                                                for local_replace_subtitle_segment_line in local_replace_subtitle_segment_file:
                                                    ...
                                                    if local_replace_subtitle_segment_line.find(".webvtt") >= 0:
                                                        ...
                                                        # local_vtt_fragment = ""
                                                        # self.file_manager.validate_dir(self.file_manager.out_path, local_replace_basepath)
                                                        # local_vtt_fragment = local_input_directory + subtitle_language + "." + manifest_extension
                                                        # remote_vtt_fragment = local_input_directory + subtitle_language + "." + manifest_extension
                                        else:
                                            self.file_manager.log("FAILED [" + media_id + "]" +
...
folder = "00001-00002"
# folder = "00001-01000"
instance = PreparingSubtitlesHLS(UNIQUE_RUN_ID+"/"+folder)
